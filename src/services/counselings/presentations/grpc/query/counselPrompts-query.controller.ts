...
export class GrpcCounselPromptQueryController {
  ...
  async findPromptVersions(
    request: FindPromptVersionsRequest
  ): Promise<FindPromptVersionsResponse> {
    ...
    return create(FindPromptVersionsResponseSchema, {
      promptVersions: promptVersions.map((version) =>
        SchemaCounselPromptsMapper.toPromptVersionProto(version)
      ),
    });
  }
  ...
  async findPromptVersionById(
    request: FindPromptVersionByIdRequest
  ): Promise<FindPromptVersionByIdResponse> {
    ...
    return create(FindPromptVersionByIdResponseSchema, {
      promptVersion: promptVersion
        ? SchemaCounselPromptsMapper.toPromptVersionProto(promptVersion)
        : undefined,
    });
  }
  ...
  async findTemporaryVersion(
    request: FindTemporaryVersionRequest
  ): Promise<FindTemporaryVersionResponse> {
    const promptVersion =
      await this.promptVersionsFacade.getTemporaryPromptVersion();
  ...
  async findActiveVersion(
    request: FindActiveVersionRequest
  ): Promise<FindActiveVersionResponse> {
    const promptVersion =
      await this.promptVersionsFacade.findActivePromptVersion();
  ...
  async findPersonaPromptById(
    request: FindPersonaPromptByIdRequest
  ): Promise<FindPersonaPromptByIdResponse> {
  ...
  async findTonePromptById(
    request: FindTonePromptByIdRequest
  ): Promise<FindTonePromptByIdResponse> {
    ...
    return create(FindTonePromptByIdResponseSchema, {
      tonePrompt: tonePrompt
        ? SchemaCounselPromptsMapper.toTonePromptProto(tonePrompt)
        : undefined,
    });
  }
  ...
  async findOrderedCounselTechniques(
    ...
    const counselTechniques =
      await this.counselTechniquesFacade.findOrderedCounselTechniques({
  ...
  async findCounselTechniqueById(
    request: FindCounselTechniqueByIdRequest
  ): Promise<FindCounselTechniqueByIdResponse> {
    const { counselTechniqueId } = request;
    const counselTechnique =
      await this.counselTechniquesFacade.findCounselTechniqueById({
        counselTechniqueId: new UniqueEntityId(counselTechniqueId),
      });
    return create(FindCounselTechniqueByIdResponseSchema, {
      counselTechnique:
        SchemaCounselPromptsMapper.toCounselTechniqueProto(counselTechnique),
    });
  }
  ...
  async findPromptActivateHistories(
    ...
    const { promptVersionId } = request;
    const histories =
      await this.promptActivateHistoryService.findPromptActivateHistories({
        promptVersionId: promptVersionId
          ? new UniqueEntityId(promptVersionId)
          : undefined,
      });
